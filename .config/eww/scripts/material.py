...
def get_colors(colorscheme: Any) -> dict[str, str]:
    colors = {
...
def get_colors_from_img(image: Any, scheme: Any) -> dict[str, str]:
    """Get colors from an image

    Args:
        image (Any): The image to get colors from
        scheme (Any): The scheme to follow

    Returns:
        dict[str,str]: a color theme based on the image
    """
